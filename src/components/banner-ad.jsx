...
const BannerAd = ({ title, subtitle, btnTitle, btnLink, image }) => (
  <div className="relative my-20 flex bg-radial-[at_20%_90%] from-sky-400 via-blue-500 to-gray-950 after:absolute after:-bottom-0.5 after:h-16 after:w-full after:bg-neutral-800 after:[clip-path:polygon(0_100%,100%_100%,0_0)]">
